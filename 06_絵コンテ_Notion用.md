...
```
日本のテレビニュース放送画面、NHKスタイルの速報アラート、上部に赤い「速報」バナー、「知床 観光船と連絡取れず」を表示するテキストオーバーレイエリア、ブラウン管テレビ画面のテクスチャとわずかな走査線、テレビ画面を撮影した美学
```
...
```
車窓越しのスマートフォン動画スクリーンショット、ウトロ港知床北海道に近づく、曇った朝空、港に漁船、窓の反射とわずかな結露、素人観光客の映像美学、iPhone 13動画品質、やや彩度が高い色、オート露出調整が見える、角にRECインジケーター、タイムスタンプ「2022/04/23 09:32」、手持ちの揺れ
```
...
```
車から砂利駐車場に降りる足元のスマートフォンPOV動画、日本人観光客の靴、降車中に誤って下を向いたカメラ、ちらっと見えるウトロ港駐車場、不安定な素人フレーミング、動きによるモーションブラー、iPhone動画の美学、一瞬のピンボケ、オートフォーカスの迷い、カジュアルな意図しない映像
```
...
```
ウトロ漁港に停泊する小さな白い日本の観光船のスマートフォン動画、これから乗る船を撮影する観光客、KAZU Iスタイルの約19トンの船、素人旅行動画の美学、iPhone 13カメラ品質、空からのわずかなレンズフレア、明るい空へのオート露出で船がやや暗い、手持ちの緩やかな動き、ワクワクした観光客の視点
```
...
```
小さな日本の船会社事務所の内部、「波浪注意報」テキストの気象警報を表示する古いブラウン管テレビ、書類と灰皿で散らかった机、2022年4月を示す壁のカレンダー、蛍光灯が落とす硬い影、リアルな日本の中小企業オフィスの雰囲気、ドキュメンタリー再現スタイル
```
...
```
日本の観光船カウンターで乗客登録用紙に記入する手のスマートフォン動画、紙に書くボールペン、旅の思い出として瞬間を記録する観光客、色あせたパンフレットが置かれたツアー会社のカウンター、やや揺れる素人映像、iPhoneの浅い被写界深度のクローズアップ動画、カジュアルな記録スタイル
```
...
```
小型旅客船に乗り込む金属製タラップを上がるスマートフォンPOV、片手で手すりを握りもう片手で撮影、前方にボートデッキが見える、揺れる素人の乗船映像、モーションブラーのあるiPhone動画、オートフォーカス調整中、ワクワクした観光客の視点、カジュアルな旅行vlogスタイル
```
...
```
小型旅客船の船内でのスマートフォン動画、窓を指差して興奮する7歳の日本人女の子を親が撮影、リップシンク用に口と唇が見える子供の横顔、喜びの表情、明るい光と海が見える窓、スマホで捉えた温かい家族の瞬間、iPhoneポートレートモードの美学、やや白飛びした窓、子供にシャープなフォーカス
```
...
```
ウトロ港を出発する小さな白い観光船の空撮ドローンショット、港を離れるKAZU Iスタイルの船、穏やかな灰色の海に航跡、知床半島の海岸線が見える、コンクリート防波堤のある漁港、曇り空、柔らかな朝の光、DJI Inspire 3ドローン映像、滑らかなシネマティック追従ショット
```
...
```
ボートデッキからオホーツク海の水平線を見るスマートフォン動画、景色を撮影する観光客、右側に知床半島の海岸線、広大な外洋、穏やかな波、水平線で出会う曇った灰色の空と海、わずかなデジタルノイズのあるiPhone動画、船の揺れによる手持ちの動き、明るい空へのオート露出調整
```
...
```
観光船から海越しに見るオシンコシンの滝のスマートフォン動画、断崖から流れ落ちる有名な双子の滝、デジタルズームを使用してピクセル化と画質低下が起きている観光客、iPhoneの最大ズームの美学、揺れる手持ち映像、2つの流れに分かれる滝、デジタルズームによる圧縮アーティファクト
```
...
```
知床の岩の海岸線を歩く北海道ヒグマのスマートフォン動画、遠くの熊を必死にズームしようとする観光客、深刻な画質劣化を伴う極端なデジタルズーム、非常に揺れる興奮した手持ち映像、水際で餌を探す小さな姿の熊、距離に苦戦するiPhoneカメラ、ピクセル化してノイジーな画像
```
...
```
小型日本観光船の船内でのスマートフォン動画、くつろぐ他の乗客をさりげなく撮影、窓の外を見て微笑む家族、おしゃべりする老夫婦、スマホをチェックする若い観光客、温かく幸せな雰囲気、窓からの柔らかな日光、iPhoneのキャンディッド映像スタイル、自然なポーズのない瞬間
```
...
```
船会社事務所で緊急電話に出る日本人男性のドキュメンタリー再現ショット、落ち着こうとする心配そうな表情、カジュアルな服装の中年オフィスワーカー、蛍光灯のオフィス照明、船のスケジュールで散らかった机、見える気象FAX印刷物、ますます心配そうな顔へのスローズーム
```
...
```
知床半島の険しい海岸沿いを航行する小さな白い観光船の高高度空撮ドローンショット、広大な海に対して小さく見えるKAZU Iスタイルの船、他の船が見えない劇的な断崖の海岸線、深い灰色のオホーツク海、細い白い航跡を残す船、孤立した脆弱な船
```
...
```
悪化する海況を映す船室窓越しのスマートフォン動画、白波が増える荒れた波、2-3メートルのうねりが見える、不吉に暗くなる灰色の空、時々窓に当たる水しぶき、船が揺れてますます揺れる手持ち映像、乗客の高まる不安を捉えるiPhone動画、変化する光でオート露出が変動
```
...
```
揺れる船室内でのスマートフォン動画、母親にしがみつく怖がる7歳の日本人女の子、リップシンク用に口が見える怯えた子供の顔、安心させようとするが心配そうな表情で子供を守るように抱く母親、見えて傾く船室、背景に不安そうな他の乗客、家族の恐怖を捉えるiPhone映像
```
...
```
激しく揺れる船室内のスマートフォン動画、極端なカメラの揺れとモーションブラー、パニックで座席にしがみつく乗客、傾いた床を滑るバッグと荷物、一部フレームアウトする混沌とした場面、ちらつく蛍光灯、激しく傾いた窓から見える水、急速な動きによる深刻な圧縮アーティファクトのあるiPhone映像
```
...
```
金属の手すりを必死に握る複数の手を偶然捉えたスマートフォン動画、緊張で白くなった指関節、異なる手-しわのある高齢者、大人、小さな子供の手、意図的に撮影していないカメラ-偶発的な映像、極端な揺れ、部分的にピンボケ、混乱の中のiPhone動画
```
...
```
荒れ狂う嵐の海でもがく小さな白いボートの空撮ドローンショット、3-4メートルの波に翻弄されるKAZU Iスタイルの船、海面を覆う白い泡と水しぶき、暗く脅威的な灰色の空、背景に知床の断崖海岸線、巨大な怒れる海に対する小さく脆弱な船
```
...
```
VHF船舶無線で緊急に呼びかける日本の船会社社員のドキュメンタリーショット、必死の表情でハンドセットに話す、近くのメモ帳に「KAZU I」の文字、散らかった机の上の無線機、壁に嵐を示す天気図、外の荒れた港の状況が見える窓、緊迫した雰囲気
```
...
```
VHF船舶無線スピーカーグリルの極端なクローズアップ、赤く点滅するLEDインジケーターと静的ノイズの視覚化、使用年数を示す使い込まれた無線機、硬い光線の中を浮遊する塵、応答なしの雰囲気、暗示される深い沈黙、ドキュメンタリーの詳細証拠ショット
```
...
```
船首から船室に浸水してくる水を捉えたスマートフォン動画、床に急速に広がる海水、濡れ始める乗客の足、誰かのパニックの声、信じられない思いで上昇する水を見下ろすiPhoneカメラ、濡れる靴とバッグ、パニックによる極端なカメラの揺れ、水面に反射する蛍光灯
```
...
```
30度傾いた船室のスマートフォン動画、パニックする乗客が持つiPhoneが方向感覚を失わせる傾いた視界を映す、座席や手すりに必死にしがみつく乗客、低い側に溜まって揺れる水、滑る荷物、掴まれる救命胴衣、一部見える怯えた顔、極端なモーションブラーと揺れ
```
...
| **テロップ（日）** | 第一管区海上保安本部 |
| **テロップ（英）** | 1st Regional Coast Guard Headquarters |
...
```
118番緊急通報を受ける海上保安庁通信センター、海図を表示する複数のモニターを見るヘッドセットをつけたオペレーター、プロフェッショナルな緊迫した雰囲気、制服姿の男性海保官、画面と無線機を備えた近代的な通信機器、モニターからの青みがかった室内照明
```
...
| **視点** | A（乗客カメラ）📱 |
| **映像** | 携帯電話で通報する船長の後ろ姿 |
| **音声（日）** | 船長「浸水している…沈みそうだ…」（実際の通報内容に基づく） |
...
```
後ろから携帯電話で緊急通報する船長をちらりと映すスマートフォン動画、浸水して傾いた操舵室に立つ制服姿の船長、足首までの上昇する水、電話を耳に当てながら必死に手すりを握る、乗客のiPhoneが偶然この瞬間を扉越しに捉える、混乱した揺れる映像
```
...
```
家族に最後の電話をする他の乗客を捉えたスマートフォン動画、涙を流しながら耳に電話を当てる中年の日本人男性、今や膝までの水位、着用した救命胴衣、壊滅的な別れの瞬間、浸水して傾いた船室に見える他の乗客、耐えられない人間の悲劇のiPhone映像
```
...
```
沈みゆく船内で胸の高さの水からのスマートフォン動画、必死の手が水上に持ち上げるiPhone、フレームの大部分を満たす水面、船室の天井とちらつく照明の最後の光景、浮かぶ救命胴衣と残骸、恐ろしい最後の視点、今にも水没しそうなカメラ、レンズについた水滴
```
...
```
水中に沈むスマートフォンカメラ、水面の下に行くiPhone画面の視界、水を通した歪んだ画像、レンズの前を上昇する気泡、濁った緑青色の水を通した船室内部の最後の光景、急速に薄れる光、スマホが沈む視点、水没ダメージで乱れ破損する画面、暗闘と信号喪失への移行
```
...
| CUT | テロップ（日） | テロップ（英） | 尺 |
|-----|---------------|---------------|-----|
| 31 | 14時17分 | 2:17 PM | 2秒 |
| 32 | 通信途絶 | Communication Lost | 3秒 |
| 33 | （完全な無音と黒） | (Complete silence and black) | 2秒 |
...
| **テロップ（英）** | Kushiro Air Station, 1st Regional Coast Guard |
| **音声** | ヘリのローター音、無線の声 |
| **カメラ** | 報道カメラ風、固定→パン |
| **意図** | 救助活動の開始 |
...
```
海上保安庁釧路航空基地、緊急離陸準備するヘリパッドの救難ヘリコプター、番号が見える白と赤の海保ヘリ塗装、走るオレンジ色のフライトスーツの地上クルー、回転し始めるローター、緊迫した曇り空、ニュース放送映像スタイル
```
...
```
港から緊急出航する海上保安庁巡視船、船体に「くなしり」の名前が見えるくなしりスタイルの海保船、青い斜めストライプの白い船体、港の水を切る船首、オレンジ色の装備でデッキに見えるクルー、ドラマチックな灰色の空、埠頭からのニュースカメラ追従ショット
```
...
```
荒れた灰色のオホーツク海上を低空飛行する海上保安庁救難ヘリコプター、グリッドパターンで捜索、暗い水を照らすヘリコプターのスポットライト、背景に知床半島の劇的な断崖、嵐の空に映える白と赤の海保ヘリ、巡視船からのニュース望遠レンズショット
```
...
```
広大な空の海を捜索する救難ヘリコプターからの空撮、白波のある荒れた灰色の海を見下ろす、生存者は見えない、遠くに知床の海岸線、ショットに見えるヘリコプターの窓枠、FLIR熱カメラ表示オーバーレイの示唆、必死の無駄な捜索の雰囲気、圧倒的な絶望感
```
...
```
知床半島近くのオホーツク海に沈む夕日、暗く落ち着かない水に映るドラマチックな血のようなオレンジと深紅の空、険しい断崖のシルエット、メランコリックで壊滅的な雰囲気、消えゆく希望の象徴、水平線にまだ捜索を続ける巡視船の小さなシルエット
```
...
```
夜間の海上捜索活動、黒い海を掃引する複数の強力なサーチライトを備えた海上保安庁巡視船、暗闇と霧を切り裂くスポットライトの光線、デッキに見えるクルーのシルエット、ライトを反射する荒れた暗い水、曇りの向こうにかろうじて見える星
```
...
```
夜のウトロ港の場面、港の端で待つ家族の遠いシルエット、暗い水に映る港の灯り、毛布を持つ人もいる小さなグループで寄り添う人々、敬意ある距離を保つニュースカメラ、曇った夜空、壊滅的な徹夜の見守りの雰囲気、尊厳を保つドキュメンタリーの観察ショット
```
...
```
灰色の海面に一人で浮かぶオレンジ色の救命胴衣、穏やかな波の中を漂う単独の救命ベスト、曇った厳粛な空、背景の霧を通してかろうじて見える知床の海岸、悲劇の深い象徴、ゆっくり近づく巡視船からのニュースカメラ、壊滅的な発見の瞬間
```
...
```
担架が通過する際に正式な敬礼をする海上保安官、最大限の敬意を持って運ばれる白い覆いの担架、整列して気をつけの姿勢で立つ正装の官吏、背景に巡視船のある港の埠頭、曇った厳粛な灰色の空、深い敬意と喪の儀式、尊厳ある距離を保つニュースカメラ
```
...
```
ウトロ港の水辺に並べられた追悼の花と写真、白い菊とカラフルな花束、黒いリボンのついた額入り写真、燃えるお香、小さな供え物、日本式の追悼スタイル、花を優しく揺らす風、曇った灰色の空、深いコミュニティの悲嘆、追悼をゆっくりパンするドキュメンタリー
```
...
| 46 | 水中に浮かぶ白いテロップ「26名全員が亡くなった」 | All 26 perished | 15秒 |
...
```
上の水面から差し込む幻想的な光線のある深い水中の場面、魂が昇っていくような浮遊する粒子のある深い青の海水、平和だが深く悲しい雰囲気、抽象的な追悼のイメージ、魂が昇っていくことを表す光、シネマティックな水中撮影、夢のような最後の安息の地の視覚化
```

### CUT 46 プロンプト
**備考**: CUT 45の映像にテロップをオーバーレイ
...
```
晴れた日の知床半島近くの穏やかで平和なオホーツク海、穏やかな波のある静かな青い水、劇的な断崖の海岸線、人間の悲劇に無関心で変わらない自然、美しいがhaunting な風景、下の恐怖を隠す見事な自然の美しさ、ドローンの広いエスタブリッシングショット
```
...
|------|------|
| **映像** | 黒背景にクレジット |
| **テロップ（日）** | この作品はAI技術で制作されました / 犠牲者のご冥福をお祈りします |
| **テロップ（英）** | This film was created using AI technology / In memory of the victims |
| **音声** | 穏やかな波音（フェードアウト） |
...
| プロンプト要素 | 説明 |
|---------------|------|
| `Smartphone video` / `iPhone video` | スマホ撮影であることを明示 |
| `amateur footage` / `tourist footage` | 素人撮影感 |
| `handheld shake` | 手ブレ |
| `auto-focus hunting` | オートフォーカスの迷い |
| `auto-exposure adjusting` | 自動露出の変動 |
| `digital zoom with quality loss` | デジタルズームによる画質劣化 |
| `compression artifacts` | 動画圧縮ノイズ |
| `slightly oversaturated colors` | スマホ特有の高彩度 |
| `REC indicator` / `timestamp` | 録画UI表示 |
| `casual documentation` | カジュアルな記録スタイル |
...
| プロンプト要素 | 説明 |
|---------------|------|
| `Sony FX6` / `documentary style` | プロ機材、報道スタイル |
| `news camera` / `broadcast footage` | ニュース映像風 |
| `DJI drone cinematic` | ドローン空撮 |
| `tripod mounted` | 三脚固定 |
| `4K broadcast quality` | 放送品質 |
| `professional color grading` | プロのカラグレ |
| `respectful distance` | 報道の敬意ある距離感 |
...
| ツール | 主な用途 | カット例 |
|--------|---------|---------|
| **Kling AI 2.6** | 人物の動き、Lipsync、手ブレ | CUT 9, 17, 14, 19 |
| **Runway Gen-4.5** | シネマティック、ドローン、水流 | CUT 10, 15, 20, 24 |
| **Pika Labs** | 特殊効果、水没、グリッチ | CUT 6B, 30, 45 |
...
|------|----------|---------|
| 0:00 | 2022年4月23日 北海道・知床半島沖 | April 23, 2022 - Off the coast of Shiretoko Peninsula, Hokkaido |
| 0:15 | これは、その12時間前の記録である。 | This is a record from 12 hours before. |
| 0:22 | 2022年4月23日 午前9時30分 ウトロ | April 23, 2022, 9:30 AM - Utoro |
| 1:12 | ママ見て！海だよ！ | Mommy, look! It's the ocean! |
| 1:22 | 午前10時00分 出航 | 10:00 AM - Departure |
| 2:58 | 午後12時30分頃 | Around 12:30 PM |
| 3:13 | ママ、怖い… / 大丈夫よ、もうすぐ戻るから | Mommy, I'm scared... / It's okay, we'll be back soon |
| 4:23 | 13時13分 | 1:13 PM |
| 4:58 | 第一管区海上保安本部 | 1st Regional Coast Guard Headquarters |
| 5:58 | 14時17分 / 通信途絶 | 2:17 PM / Communication Lost |
| 6:05 | 第一管区海上保安本部 釧路航空基地 | Kushiro Air Station, 1st Regional Coast Guard |
| 6:20 | 巡視船「くなしり」 | Patrol Vessel "Kunashiri" |
| 7:18 | 捜索は夜を徹して続けられた | The search continued through the night |
| 8:17 | 72時間後 | 72 hours later |
| 9:47 | 乗客乗員26名 | 26 passengers and crew |
| 9:50 | 子供2名を含む | Including 2 children |
| 9:53 | 6名は今も行方不明 | 6 remain missing to this day |
| 10:08 | 二度と繰り返さないために | So that this never happens again |
...
| フェーズ | 期間 | 内容 |
|---------|------|------|
| **Phase 1** | Week 1-2 | 全40カットのMidjourney画像生成 |
| **Phase 2** | Week 3-4 | 動画生成（Kling/Runway/Pika） |
| **Phase 3** | Week 5 | ElevenLabs音声生成・Lipsync |
| **Phase 4** | Week 6 | 編集・テロップ・サウンドデザイン |
| **Phase 5** | Week 7 | 4Kアップスケール・カラーグレーディング |
| **Phase 6** | Week 8 | 最終調整・書き出し・提出 |

**締切**: 2026年2月15日

---

*このストーリーボードは WAIFF KYOTO 2026 審査用資料として作成されました。*
*全ての映像はAI技術を使用して制作されます。*
...
|------|------|
| 2026-02-01 | 初版作成 |
| 2026-02-01 | **視点Aのカメラスタイルを修正**: Arri Alexa（映画カメラ）→ iPhone/スマートフォン風に変更。素人撮影感、手ブレ、デジタルズーム劣化、オートフォーカスの迷い、RECインジケーター等を追加 |
| 2026-02-01 | **全テロップに英語訳を追加**: WAIFF提出要件に対応。全カットのテロップ欄に「テロップ（日）」「テロップ（英）」を併記。音声セリフにも英語字幕を追加 |
